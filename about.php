                  ...
                  <div class="input_l colorprimary">
                    <form action="lang/translate.php" method="POST">
                      <select name="language-select" id="language-select" class="select_language colorprimary" onchange="this.form.submit()">
                        <option class="opt_l" value="0">Select your language</option>
      ...
      <div class="row">
        <div class="col l12">
          <div class="container" id="about">
            ...
            <p class="desc"> If you have any comments, any ideas for new formats that I would like to see here, we will be grateful and would be very happy to be able to help and receive your comment or constructive criticism with a smile. Feel free, enjoy. If you use <b> AdBlock </b> or any other <b> ad blocker </b>, please disable it so we can keep the site live for you and others in need. Thanks for understanding &#128522;</p>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col l4 offset-l2 s12">
              ...
              <ul>
                <li><a class="grey-text text-lighten-3 sel" href="index.php">Home</a></li>
              </ul>
            </div>
          </div>
        </div>
