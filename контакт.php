...
<html lang="ru-RU">
  <head>
    ...
    <!-- title -->
    <title>Convert Type - Контакты</title>
      ...
      <div class="row">
        <div class="col l12">
          <div class="container" id="contact">
						<h4>КОНТАКТЫ</h4>
            <p class="desc"> Вы можете связаться с нами через все страницы (главная, информация, руководство, политика и конфиденциальность), но вы также можете напрямую связаться через эту страницу контактов. Не стесняйтесь говорить о чем угодно! приветствуется конструктивная критика, любые комментарии, благодарности, поздравления, просьбы о новом формате или новом типе конверсии, что бы вы ни пожелали и на любом языке, не стесняйтесь и наслаждайтесь нашим инструментом. </p>
