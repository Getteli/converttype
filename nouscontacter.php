...
<html lang="fr-FR">
  <head>
    ...
    <!-- title -->
    <title>Convert Type - Nous contacter</title>
      ...
      <div class="row">
        <div class="col l12">
          <div class="container" id="contact">
						<h4>CONTACT</h4>
            <p class="desc"> Vous pouvez nous contacter via toutes les pages, (accueil, à propos, tutoriel, politique et confidentialité) Mais vous pouvez également entrer en contact direct via cette page de contact. N'hésitez pas à parler de tout ce que vous voulez! les critiques constructives sont les bienvenues, tout commentaire, merci, félicitations, une demande pour un nouveau format ou un nouveau type de conversion, comme vous le souhaitez et dans n'importe quelle langue, n'hésitez pas et profitez de notre outil.</p>
