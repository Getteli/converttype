      ...
      <div class="row">
        <div class="col l12">
          <div class="container" id="contact">
						<h4>連絡先</h4>
            <p class="desc">すべてのページ（ホーム、概要、チュートリアル、ポリシー、プライバシー）からお問い合わせいただけますが、このお問い合わせページから直接連絡することもできます。 何でもお気軽にご相談ください！ 建設的な批判を歓迎します。コメント、感謝、おめでとう、新しいフォーマットまたは新しいタイプの変換のリクエスト、好きなように、どんな言語でも、気軽にツールを楽しんでください。</p>
