...
<html lang="es-ES">
  <head>
    ...
    <!-- title -->
    <title>Convert Type - Contacto</title>
      ...
      <div class="row">
        <div class="col l12">
          <div class="container" id="contact">
            <h4> CONTACTO </h4>
            <p class="desc">Puede contactarnos a través de todas las páginas, (inicio, acerca de, tutorial, política y privacidad) Pero también puede ponerse en contacto directo a través de esta página de contacto. ¡Siéntete libre de hablar sobre lo que quieras! Las críticas constructivas son bienvenidas, cualquier comentario, agradecimiento, enhorabuena, una solicitud de un nuevo formato o un nuevo tipo de conversión, lo que desees y en cualquier idioma, siéntete libre y disfruta de nuestra herramienta.</p>
