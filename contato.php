...
<html lang="pt-BR">
  <head>
    ...
    <!-- title -->
    <title>Convert Type - Contato</title>
      ...
      <div class="row">
        <div class="col l12">
          <div class="container" id="contact">
						<h4>CONTATO</h4>
            <p class="desc">Você poderá entrar em contato conosco por todas as páginas, (inicio, sobre, tutorial, politica e privacidade) Mas poderá também entrar em contato direto por esta página de contato. Fique a vontade para falar sobre o que desejar ! críticas construtivas são bem vindas, algum comentário, agradecimento, parabenização, um pedido para um novo formato ou novo tipo de conversão, o que desejar e em qualquer lingua, sinta-se a vontade e bom proveito de nossa ferramenta.</p>
