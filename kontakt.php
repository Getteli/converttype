...
<html lang="de-DE">
  <head>
    ...
    <!-- title -->
    <title>Convert Type - Kontakt</title>
      ...
      <div class="row">
        <div class="col l12">
          <div class="container" id="contact">
            <h4> KONTAKT </h4>
            <p class="desc">Sie können uns über alle Seiten kontaktieren (Startseite, Info, Lernprogramm, Richtlinien und Datenschutz). Sie können jedoch auch über diese Kontaktseite direkten Kontakt aufnehmen. Fühlen Sie sich frei, über alles zu sprechen, was Sie wollen! Konstruktive Kritik ist willkommen, Kommentare, Dank, Glückwünsche, eine Anfrage nach einem neuen Format oder einer neuen Art der Konvertierung, was auch immer Sie wünschen und in jeder Sprache, fühlen Sie sich frei und genießen Sie unser Tool.</p>
