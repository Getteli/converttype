...
<html lang="it-IT">
  <head>
    ...
    <!-- title -->
    <title>Convert Type - Contatto</title>
      ...
      <div class="row">
        <div class="col l12">
          <div class="container" id="contact">
						<h4>CONTATTO</h4>
            <p class="desc"> Puoi contattarci attraverso tutte le pagine, (home, about, tutorial, policy e privacy) Ma puoi anche metterti in contatto diretto attraverso questa pagina dei contatti. Sentiti libero di parlare di tutto ciò che vuoi! critiche costruttive sono benvenute, qualsiasi commento, grazie, congratulazioni, una richiesta di un nuovo formato o un nuovo tipo di conversione, qualunque cosa desideri e in qualsiasi lingua, sentiti libero e goditi il ​​nostro strumento. </p>
